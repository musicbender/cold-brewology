...
//SHOP list
export const FETCH_SHOP = 'FETCH_ARTICLES';
export const FETCH_SHOP_SUCCESS = 'FETCH_ARTICLES_SUCCESS';
export const FETCH_SHOP_FAILURE = 'FETCH_ARTICLES_FAILURE';
export const RESET_SHOP = 'RESET_ARTICLES';
